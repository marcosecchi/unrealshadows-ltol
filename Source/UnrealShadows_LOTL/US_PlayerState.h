...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnLevelXpUp, AUS_PlayerState*, PlayerState, int32, NewLevelXp);
...
protected:
	...
	UFUNCTION()
	void OnRep_LevelXpUp(int32 OldLevelXp);
